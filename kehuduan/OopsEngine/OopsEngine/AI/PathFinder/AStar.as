package OopsEngine.AI.PathFinder
{
	...
	public class AStar
	{
		...
		//	Constants
		//====================================
		private const COST_STRAIGHT : int = 10;			//横或竖向移动一格的路径评分
		private const COST_DIAGONAL : int = 14;			//斜向移动一格的路径评分
		...
		private var m_mapTileModel : IMapTileModel;		//地图模型
		 ...
		 */		
		public function AStar(p_mapTileModel : IMapTileModel, p_maxTry : int = 300)
		{
