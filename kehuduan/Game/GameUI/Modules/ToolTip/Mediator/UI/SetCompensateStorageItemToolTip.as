package GameUI.Modules.ToolTip.Mediator.UI
{
	...
	public class SetCompensateStorageItemToolTip implements IToolTip
	{
		...
		public function SetCompensateStorageItemToolTip(view:Sprite, data:Object, isDrag:Boolean = false, closeHandler:Function = null)
		{
			this.toolTip = view;
			this.data = data;
			this.isDrag = isDrag;
