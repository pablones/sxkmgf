...
const unsigned short _MSG_MAINSERVER=_MSG_GENERAL+55;
...
const unsigned short _MSG_VAS	=_MSG_GENERAL+1052;///增值服务消息
const unsigned short _MSG_GMSTOPACCOUNT	= _MSG_GENERAL + 1062;	//  [8/15/2007 Add By HaLei] GM封号
const unsigned short _MSG_WARGAME		= _MSG_GENERAL + 1064;
const unsigned short _MSG_EXAM			= _MSG_GENERAL + 1066;//  [9/22/2007 Administrator]
const unsigned short _MSG_WEAPONSOUL	= _MSG_GENERAL + 1070;//武魂
const unsigned short _MSG_ISSTOPACCOUNT = _MSG_GENERAL + 1075; //[2009.2.1--张冬]检查是否封号
