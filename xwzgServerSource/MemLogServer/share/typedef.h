...
const int	WORLDKERNEL_ONTIMER_MS	= 100;			// 世界线程的ONTIMER频率
const int	CLIENTKERNEL_ONTIMER_MS	= 1000;	
const int	TIMER_OFFSET_LIMIT		= 10;			// TIMER时钟误差，大于该值时会自动纠正
const int	SOCKET_PROCESS_INTERVAL	= 10;	//100;			// SOCKET轮循的频率
