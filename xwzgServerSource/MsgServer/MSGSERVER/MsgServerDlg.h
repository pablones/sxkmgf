...
// Construction
public:
	BOOL GetBoolByString(CString str);
	bool LoadConfigIni();
...
// Dialog Data
	...
	CButton	m_updatBtn;
	CButton	m_chk_lifetimeSave;
	CButton	m_chk_logSave;
...
protected:
	...
	afx_msg void OnSend();
	afx_msg void OnCheckLogsave();
	afx_msg void OnExportBtn();
	afx_msg void OnCheckItemLifeSave();
	afx_msg void OnButtonConfig();
	afx_msg void OnUpdate();
	afx_msg void OnKickoutalluser();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
