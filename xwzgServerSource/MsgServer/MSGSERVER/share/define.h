...
//////////////////////////////////////////////////////////////////////
// 配置
#define		CONFIG_FILENAME		"msgserver.ini"				//06.10.17王玉波修改
#define		PKMATCH_CONFIGFILE  "pkmatch.ini"		//  [12/28/2007 朱斌]	
...
const int	SERVER_LISTEN_PORT_DEFAULT		= 4808;			// 服务器监听端口
const int	SERVER_LISTEN_NPC_PORT_DEFAULT	= 4809;			//专门为NPC服务器提供的端口
const int	POINTFEE_SECS			= 5*60;			// 计点频率
const int	POINTFEE_DELAY_SECS		= 10;			// 首次计点延时
const int	SOCKET_SENDBUFSIZE		= 128*1024;			// SOCKET_BUF
const int	SOCKET_NPCBUFSIZE		= 256*1024;			// SOCKET_BUF
...
enum{
		...
		MSGPORT_MAPGROUP_INSTANCE	= MSGPORT_MAPGROUP_FIRST+1,			// 副本地图组接口-softworms-2008-1-5
};
...
const OBJID VITEM_ID_FIRST		= 1000000000;		//虚拟物品
const OBJID VITEM_ID_LAST		= 1999999999;		//虚拟物品
...
const int	COLORLIGHGTYELLOW			= 10	;			//浅黄->改为重黄
...
const int SELLTHING						=1		;			//卖东西
const int CONTRIBUT						=2		;			//捐东西
////////////////////////////////////////////////////
