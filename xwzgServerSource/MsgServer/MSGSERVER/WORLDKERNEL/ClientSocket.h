...
public:
	...
	//王玉波添以以下一个函数...
	bool		Send2StateServer(const char* pack, int nLen, bool bFlush = false);
...
//#ifdef	ENCRYPT_ENABLE
	...
	//06.8.10 王玉波添加,发往StateServer 的加密信息////////////////////////////////////////
	typedef	CEncryptClient<0x20, 0xFD, 0x07, 0x1F, 0x7A, 0xCF, 0xE5, 0x3F>	NewEncryptClient;
	NewEncryptClient m_NewEncryptSend;
	////////////////////////////////////////////////////////////////////////////////////////
//#endif
};
