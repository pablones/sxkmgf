...
//////////////////////////////////////////////////////////////////////
BOOL CMsgName::CreateHead( int nType, DWORD dwData,DWORD dwUpdateTime )
{
	// param check
	...
	m_pInfo->ucType	= nType;
	m_pInfo->dwData	= dwData;
	m_pInfo->dwSynData = dwUpdateTime;
	m_unMsgType	=_MSG_NAME;
	m_unMsgSize	=sizeof(MSG_Info)-1+m_StrPacker.GetSize();
...
//		}
//		break;
// 	case	NAMEACT_MEMBERLIST://06.10.26ÍõÓñ²¨ÐÞ¸Ä
// 		{
// 			CSyndicateWorld* pSyn = GameWorld()->QuerySynManager()->QuerySyndicate(this->GetTransData());
...
// 			pSyn->SendMemberList( pUser,m_pInfo->dwSynData );
// 		}
// 		break;
	}
}
