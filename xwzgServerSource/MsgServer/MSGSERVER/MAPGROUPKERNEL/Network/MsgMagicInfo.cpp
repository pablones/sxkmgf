...
BOOL CMsgMagicInfo::Create(UINT nAction, OBJID idTarget )
{
	// init
	this->Init();
	...
	m_pInfo->idOwner = idTarget;

	return true;
}

//////////////////////////////////////////////////////////////////////
BOOL CMsgMagicInfo::Create(OBJID idOwner, int nType, int nLevel, int nExp ,int action)
{
	CHECKF(nType);
