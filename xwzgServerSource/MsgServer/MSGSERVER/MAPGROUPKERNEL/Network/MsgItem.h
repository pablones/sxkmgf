...
public:
	...
	BOOL	Create		(USHORT nAction,DWORD dwData, OBJID idTarget=ID_NONE,USHORT usPosX = 0,USHORT usPosY = 0, OBJID id = ID_NONE, OBJID	typeId = ID_NONE, DWORD	nAmount = 1, DWORD	nMaxAmount = 1, UCHAR	ucPosition = 0, UCHAR	ucBind = 0, USHORT	usIndex = 0,DWORD dwMoney = 0,DWORD dwColor = 0);
	BOOL	Add			(OBJID id,OBJID typeId,DWORD	nAmount,DWORD nMaxAmount, UCHAR ucPosition, UCHAR ucBind, USHORT	usIndex,DWORD dwMoney = 0,DWORD dwColor = 0);
public:	
