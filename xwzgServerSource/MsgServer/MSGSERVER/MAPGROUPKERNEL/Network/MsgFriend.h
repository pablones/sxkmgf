...
const int _ENEMY_APPLY			= 20;			// to server // 添加一个仇人
const int _FRIEND_NOTALLOW		= 21;	//to server 不允许被加为好友
const int _FRIEND_PVP			= 22; //决斗
...
const int _FRIEND_REPLYFRIENDINFO = 37;
const int _FRIEND_SETFACE		= 38;//修改好友脸	
const int _FRIEND_HAVETEAM_MT	= 101;//其他地图组发来的消息

//
CONST INT _FRIEND_WHETHER_ADDFRIEND =38; //是否同意加为好友
const int _FRIEND_ADDSUCCESS_PASSIVE =39; //被动添加好友成功 to client
