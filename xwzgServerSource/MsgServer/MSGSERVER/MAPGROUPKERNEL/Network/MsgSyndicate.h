...
enum{
	...
	SYN_ANNONCE_OTHERLINE	=220,///同步其它线的公告
	SYN_EVERYSUB			=221,
	SYN_BUILDER				=222,
...
public:
	...
	//20070403修罗:用来发送目标名字
	BOOL	Create(unsigned short usAction, OBJID idTarget, const char *szTargetName,unsigned short dwData=0,const char *szWords="");
public:	
	BOOL Create(unsigned short usAction, unsigned short dwData, OBJID idTarget, char* szBuf);
