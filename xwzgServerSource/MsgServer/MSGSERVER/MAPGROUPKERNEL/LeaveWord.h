...
////////////////////////////////////////////////////////////////////////////////////////////
const int	PLAYER_WORDS_PER_TIME	= 5;				// 玩家每次读取5条留言
...
const int	MAX_LEAVEWORD_COUNTS	= 5;				// 留言条数上限
...
public:
	...
	bool	CheckWords(char* word,int nMaxSize);
	ULONG	Release			()							{ delete this; return 0; }
	bool	InsertWords		(LPCTSTR szSender, LPCTSTR szRecvUser, LPCTSTR szWords, LPCTSTR szColor="0");//[2010-06-10 goto]增加文本颜色字段
	int		CountWords		(LPCTSTR szSender, LPCTSTR szReceiver=NULL);
