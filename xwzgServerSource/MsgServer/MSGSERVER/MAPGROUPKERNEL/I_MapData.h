...
public: // application
	...
	virtual bool	FindPath(PASSPATH0* pPathBuf, int nBufSize, POINT posSource, POINT posTarget, int nEscapeSteps = 0)		PURE_VIRTUAL_FUNCTION_0
...
//	virtual int		GetSurfaceAlt	(int nCellX, int nCellY)				PURE_VIRTUAL_FUNCTION_0
	//...
public: // role
	virtual bool	IncRole			(int nCellX, int nCellY, int nVal = 1)				PURE_VIRTUAL_FUNCTION
	virtual bool	DecRole			(int nCellX, int nCellY, int nVal = 1)				PURE_VIRTUAL_FUNCTION
