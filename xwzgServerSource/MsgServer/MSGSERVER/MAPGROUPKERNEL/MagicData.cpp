...
// 			break;
// 		case MAGICDATA_GIFTFLAG:				//zeng临时魔法缺少该字段
// 			return m_data.dwGiftFlag;
// 			break;
// 		case MAGICDATA_ADDLEVEL:
// 			return m_data.dwAddLevel;
// 			break;
// 		case MAGICDATA_LEARN:
// 			return m_data.dwLearn;
// 			break;
		default:
...
// 		break;
// 	case MAGICDATA_GIFTFLAG:				//zeng临时魔法缺少该字段
// 		m_data.dwGiftFlag = nData;
// 		break;
// 	case MAGICDATA_ADDLEVEL:
// 		m_data.dwAddLevel = nData;
// 		break;
// 	case MAGICDATA_LEARN:
// 		m_data.dwLearn = nData;
// 		break;
	default:
		::LogSave("Invalid MAGICDATA [%d]", idx);
		break;
	}
	if(idx == MAGICDATA_LEVEL)// || idx == MAGICDATA_ADDLEVEL)
	{
		GetMagicLevel();
	}
}
