...
<div class="bg">
    <div class="loing">
      <form onsubmit="return check_input();" target="_self" id="frm_center" name="frm_center" method="post" action="http://web.4399.com/user/login_actions.php">
        ...
        <input type="hidden" value="S2" name="server_id">
        <input type="hidden" value="http://web.4399.com/stat/togame.php?target=yjjh&server_id=S2&a=good4399&cid=30001" name="topage">
