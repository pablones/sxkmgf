...
/* 数据库表名常量 */
//account
define('TBL_SYS_CONFIG' , 'sys_config');
define('TBL_TEMPLATE','template');
define('TBL_SESSIONS_DATA','sessions_data');
define('TBL_SESSIONS','sessions');
define('TBL_ACCOUNT','account');
define('TBL_ACC_LINELOG','acc_linelog');
define('TBL_SK_PAYLOG','sk_paylog');
define('TBL_SK_VAS_TABLE','sk_vas_table');
define('TBL_SK_GENERALIZE','sk_generalize');    
define('TBL_ADMIN_USER','admin_user');
define('TBL_ADMIN_MESSAGE','admin_message');
define('TBL_SHOP_CONFIG','ecs_shop_config');
define('TBL_SER_CONSUMELOG_TABLE','ser_consumelog_table');
define('TBL_SK_ADPAYLOG','sk_adpaylog');
define('TBL_SK_NEWCARD','sk_newcard');
define('TBL_SK_TPCARD','sk_tpcard');
define('TBL_SK_NEWCARD3','sk_newcard3');
define('TBL_ADMIN_LOG','admin_log');
define('TBL_ADMIN_ACTION','admin_action');
define('TBL_ADMIN_ROLE','admin_role');
define('TBL_PLUGINS','plugins');
define('TBL_AC_LINELOG','acc_linelog');
//wangpudb
define('TBL_WB_USER','wb_user');
define('TBL_WB_ITEMTYPE','wb_itemtype');
define('TBL_WB_ITEM','wb_item');
define('TBL_WB_MAGIC','wb_magic');
define('TBL_WB_MAGICTYPE','wb_magictype');
define('TBL_WB_EUDEMON','wb_eudemon');
define('TBL_WB_EUDEMONTYPE','wb_eudemontype');
define('TBL_WB_GOOD_VAS','wb_goods_vas');
define('TBL_WB_LEAVEWORD','wb_leaveword');
define('TBL_WB_COMPENSATIONDATA','wb_compensationdata');

//yjjhpt
define('TBL_YJJHPT_ADDITEMLOG','yjjhpt_additemlog');
define('TBL_YJ_USERNUM','yjjhpt_usernum');
define('TBL_YJ_USERNUMLOG','yjjhpt_usernumlog');
define('TBL_YJ_USERASK','yjjhpt_userask');

/* memcache key值常量 */
define('USERINFO' , 'userinfo');
define('PLAYERINFO' , 'playerinfo');
define('PAYNUM' ,'paynum');
define('VASINFO' ,'vasinfo');
define('PAYZB','payzb');
define('MEMTIME',300);
define('MEMLOGTIME' , 86400);
define('PLAYPAGE' ,'playpage');
define('CFGCACHE' ,'cfgcache');
define('TIME_LIMIT' , 300);


/* 系统常用变量 */
define('THIRTY_DAY' , 2592000);
define('ONE_DAY',86400);

define('PAY_TYPE_YB',1);
define('PAY_TYPE_ZB',2);

define('LEGAL_USERID',10000000); //合法的user_id
