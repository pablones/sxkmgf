...
//FileUtil::createDir($filepath_1);                    #测试建立文件夹 建一个a/1/2/3文件夹
//FileUtil::createFile($filepath_1."/shop_config_1.php");                   # 测试建立文件        在b/1/2/文件夹下面建一个3文件
//FileUtil::createFile('b/1/2/3.exe');            # 测试建立文件        在b/1/2/文件夹下面建一个3.exe文件
//FileUtil::copyDir('b','d/e');                   # 测试复制文件夹 建立一个d/e文件夹，把b文件夹下的内容复制进去
//FileUtil::copyFile($filepath_1,$filepath_2,false); # 测试复制文件        建立一个b/b文件夹，并把b/1/2文件夹中的3.exe文件复制进去
...
//FileUtil::unlinkFile($filepath."/ex.php");            # 测试删除文件        删除b/d/3.exe文件
//FileUtil::unlinkFile($filepath."/login.dwt");
