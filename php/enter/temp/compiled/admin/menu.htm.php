...
<?php if ($this->_var['menu']['action']): ?>
  <li class="explode"><a href="<?php echo $this->_var['menu']['action']; ?>" target="main-frame"><?php echo $this->_var['menu']['label']; ?></a></li>s
<?php else: ?>
...
<?php echo $this->smarty_insert_scripts(array('files'=>'../templates/js/global.js,../templates/js/utils.js,../templates/js/transport.js')); ?>
<script language="JavaScript">
<!--
