...
<?php echo $this->smarty_insert_scripts(array('files'=>'../templates/js/transport.js')); ?>

</head>
<body>
<div id="header-div">
  <div id="logo-div" ><img src="images/login.png" alt="御剑江湖管理中心" /></div>
  ...
  <div id="submenu-div">
    <ul>
      ...
      <li>欢迎您：<?php echo $this->_var['admin_name']; ?></li>
...
<div id="menu-div">
  <ul>
    ...
    <li><a href="privilege.php?act=modif" target="main-frame"><?php echo $this->_var['lang']['set_navigator']; ?></a></li>
   	<li><a href="jump_server.php?act=list" target="main-frame"><?php echo $this->_var['lang']['jump_server']; ?></a></li>
   	<li><a href="fcm_tool.php?act=list" target="main-frame"><?php echo $this->_var['lang']['fcm_tool']; ?></a></li>
