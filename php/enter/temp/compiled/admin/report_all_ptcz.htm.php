...
<div class="main-div">
    <form action="report.php?act=all_ptcz" method="post" enctype="multipart/form-data" name="searchForm">
        <table>
             <tr>
...
<div class="list-div">
    ...
    foreach ($_from AS $this->_var['key'] => $this->_var['data']):
?>
			<th align="left" width="80"><?php echo $this->_var['key']; ?>平台</th>
			<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
			<th align="left">合计</th>
		</tr>
		<?php $_from = $this->_var['date']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'date_0_25273500_1318571415');if (count($_from)):
    foreach ($_from AS $this->_var['date_0_25273500_1318571415']):
?>
		<tr>
		    <td><?php echo $this->_var['date_0_25273500_1318571415']; ?></td>
...
?>
		    <td><?php echo $this->_var['rs'][$this->_var['date_0_25273500_1318571415']]; ?></td>
		<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		  <td><?php echo $this->_var['sum_day'][$this->_var['date_0_25273500_1318571415']]; ?></td>
		</tr>   
		<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		<tr>
		<td>合计</td>
		<?php $_from = $this->_var['sum']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'sum_0_25299100_1318571415');if (count($_from)):
    foreach ($_from AS $this->_var['sum_0_25299100_1318571415']):
?>
		    <td><?php echo $this->_var['sum_0_25299100_1318571415']; ?></td>
		<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
