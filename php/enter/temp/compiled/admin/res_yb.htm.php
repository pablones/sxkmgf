...
<form action="resource.php?act=yb_query" method="post" enctype="multipart/form-data" name="searchForm">
<table width="90%" id="mix-table"  align="center">
	<tr>
		<td>  
           ...
           <strong><?php echo $this->_var['lang']['yb_amount']; ?>:&nbsp;</strong><input type ="text" name="yb_amount[]" id="yb_amount" />
        </td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan='2'>
			<strong><?php echo $this->_var['lang']['goods_notic']; ?><br/><?php echo $this->_var['lang']['yb_notic_1']; ?><br/><?php echo $this->_var['lang']['yb_notic_1']; ?><br/><?php echo $this->_var['lang']['yb_notic_2']; ?><br/></strong>
		</td>
	</tr>
</table>
