      <tr>
        ...
        <td>
            ...
            <input name="value[<?php echo $this->_var['var']['id']; ?>]" type="text" value="<?php echo $this->_var['var']['value']; ?>" size="40" /><?php if ($this->_var['var']['url'] == 1): ?><?php echo $this->_var['lang']['sms_url']; ?><?php endif; ?>
...
?>
        ...
        <?php if ($this->_var['var']['desc']): ?>
        <br />
            <span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?>  <?php endif; ?> id="notice<?php echo $this->_var['var']['code']; ?>"><?php echo nl2br($this->_var['var']['desc']); ?></span>
        <?php endif; ?>
        </td>
      </tr>
