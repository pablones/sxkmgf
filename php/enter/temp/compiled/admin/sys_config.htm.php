...
<?php echo $this->smarty_insert_scripts(array('files'=>'../admin/templates/js/utils.js')); ?>
<?php echo $this->smarty_insert_scripts(array('files'=>'../admin/templates/js/region.js')); ?>
<div class="tab-div">
  <!-- tab bar -->
    <div id="tabbar-div">
        <p>
...
?>
                    <?php echo $this->fetch('sys_config_form.htm'); ?>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            </table>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
